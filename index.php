            ...
            <form class="w-lg-100" action="mailer/send.php" method="POST">
              <fieldset>
                ...
                <div class="row mt-lg-4">
                  ...
                  <div class="col-lg-6">
                    <button class="btn btn_small w-100" type="submit">ПОЛУЧИТЬ КАТАЛОГ<p>Персональную скидку 10%</p></button>
                  </div>
                </div>
                <div class=""> 
                ...
                <div class="col-lg-6 offset-lg-6">
                  ...
                  <form>
                    <fieldset>
                      ...
                      <button class="btn btn-primary btn_small w-100" type="submit">Рассчитать со скидкой<p>+ персональную скидку 10% на все модели</p></button>
                      <div class=""> 
                        <label class="form_accept-container">
                          <input type="checkbox" checked="checked" name="checkbox">
                          <span class="checkmark"></span>
